                    ...
                    <div class="rounded-md border border-slate-200/60 p-5 dark:border-darkmode-400">
                        ...
                        <div class="mt-5">
                            ...
                            <x-base.form-inline class="mt-5 flex-col items-start pt-5 first:mt-0 first:pt-0 xl:flex-row" formInline>
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <div class="input-form">
                                        <x-base.form-select class="w-full" name="userTypes[]" value="{{ $user->user_type }}" placeholder="Select user type" required>
                                            <option value="" disabled selected hidden>Select user type</option>
                                            @foreach($userTypes as $key => $label)
                                                <option value="{{ $key }}" {{ $user->user_type == $key ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </x-base.form-select>
                                    </div>
                                </div>                                                        
                                    ...
                                    <div class="flex flex-col sm:flex-row">
                                        ...
                                        <x-base.form-check class="mr-4 mt-2 sm:mt-0">
                                            <x-base.form-check.input
                                                ...
                                                type="radio"
                                                value="agency"
                                                checked="{{ $user->agency_id ? 'checked' : '' }}"
                                                required
                                            />
                                            <x-base.form-check.label>
                                                <div>Agency</div>
                                        ...
                                        <div class="input-form">
                                            <x-base.tom-select class="form-control" name="organization" placeholder="Select an organization">
                                                ...
                                                @foreach ($organizations as $id => $name)
                                                    <option value="{{ $id }}" {{ $user->org_id == $id ? 'selected' : '' }}>
                                                        {{ $name }}
                                                    </option>
                                                @endforeach
                                            </x-base.tom-select>
                                        ...
                                        <div class="input-form">
                                            <x-base.tom-select class="form-control" name="agency" placeholder="Select an agency">
                                                ...
                                                @foreach ($agencies as $id => $name)
                                                    <option value="{{ $id }}" {{ $user->agency_id == $id ? 'selected' : '' }}>
                                                        {{ $name }}
                                                    </option>
                                                @endforeach
                                            </x-base.tom-select>
                            ...
                            <x-base.form-inline class="mt-5 flex-col items-start pt-5 first:mt-0 first:pt-0 xl:flex-row" formInline>
                                <x-base.form-label class="xl:!mr-10 xl:w-64">
                                    <div class="text-left">
                                        ...
                                        <div class="mt-3 text-xs leading-relaxed text-slate-500">
                                            Select one or more roles for the user from the list.
                                        </div>
                                    </div>
                                </x-base.form-label>
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <div class="input-form">
                                        <x-base.tom-select class="w-full" name="roles[]" placeholder="Select role" multiple required>
...
@pushOnce('scripts')
    @vite('resources/js/pages/editUser.js')
@endPushOnce