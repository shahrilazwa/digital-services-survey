...
@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Update Digital Services</h2>
    </div>
    <div class="mt-5 grid grid-cols-11 gap-x-6 pb-20">
        <div class="intro-y col-span-11 2xl:col-span-9">
            <form class="validate-form">
                @csrf
                <!-- BEGIN: Edit Digital Service Form -->
                <input type="hidden" name="service-id" value="{{ $digital_service->id }}">
                        ...
                        <div class="mt-5">
                                ...
                                <div class="mt-2 w-full flex-1 xl:mt-0">
                                    <div class="input-form">
                                        <x-base.form-input
                                            ...
                                            value="{{ $digital_service->service_name }}"
                                            required
                                            minlength="5"
                                        />
                                    </div>
                            ...
                            <x-base.form-inline class="mt-5 flex-col items-start pt-5 first:mt-0 first:pt-0 xl:flex-row" formInline>
                                ...
                                <div class="mt-2 w-full flex-1 xl:mt-0">
                                    ...
                                    >{{ old('service-desc', $digital_service->description) }}
                                    </x-base.form-textarea>
                                </div>
                            </x-base.form-inline>
                            ...
                            <x-base.form-inline class="mt-5 flex-col items-start pt-5 first:mt-0 first:pt-0 xl:flex-row" formInline>
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <div class="input-form">
                                        <x-base.tom-select class="w-full" name="tags[]" placeholder="Select tag" multiple>
                                            @foreach ($tags as $id => $name)
                                                <option value="{{ $id }}" {{ in_array($id, $serviceTags) ? 'selected' : '' }}>
                                                    {{ $name }}
                                                </option>
                                            @endforeach                                            
                                        </x-base.tom-select>
                ...
                <!-- END: Update Digital Service Form -->
...
@pushOnce('scripts')
    @vite('resources/js/pages/editService.js')
@endPushOnce