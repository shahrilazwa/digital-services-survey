...
@section('subcontent')
    <div class="intro-y mt-8 flex items-center">
        <h2 class="mr-auto text-lg font-medium">Add Digital Platform</h2>
    </div>
                        ...
                        <div class="mt-5">
                            ...
                            <x-base.form-inline class="mt-5 flex-col items-start pt-5 first:mt-0 first:pt-0 xl:flex-row" formInline>
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <div class="input-form">
                                        <x-base.form-select class="w-full" name="platformTypes[]" placeholder="Select platform type" required>
                    ...
                    <div class="rounded-md border border-slate-200/60 p-5 dark:border-darkmode-400">
                        ...
                        <div class="mt-5">
                            ...
                            <x-base.form-inline class="mt-5 flex-col items-start pt-5 first:mt-0 first:pt-0 xl:flex-row" formInline>
                                ...
                                <div class="mt-3 w-full flex-1 xl:mt-0">
                                    <div class="input-form">
                                        <x-base.form-select class="w-full" name="eaClusters[]" placeholder="Select EA Cluster" required>
...
@pushOnce('scripts')
    @vite('resources/js/pages/createDigitalPlatform.js')
@endPushOnce